...
|------|-------------|--------|---------|--------|
| 2024-07-08 | [[citrini]] | LONG | n/a | Owned; leading advanced packaging vendor critical for miniaturizing AI SoC components |
...
## Outcome tracking
No price-at-call data is available for any of the three entries, so direct return attribution is not possible. The thesis trajectory has been consistently reinforced: the second-order advanced packaging call has been cited as validated by Citrini in 2026, and SemiAnalysis's independent analysis of the CoWoS bottleneck corroborates structural demand for OSAT capacity. The live view would be falsified if CoWoS-equivalent packaging at TSMC expands materially faster than N3 wafer output (removing the overflow opportunity), or if chiplet adoption slows and monolithic die designs reduce OSAT engagement. As of June 2026, AMKR trades at $91.00 ($21.4B mkt cap, ~49x P/E, near 52-week highs). The 10-year TSMC pact is the strongest catalyst since initial coverage, locking in the US advanced packaging growth trajectory.
