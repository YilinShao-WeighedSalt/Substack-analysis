...
|------|-------------|--------|---------|--------|
| 2024-01-03 | [[semianalysis]] | MENTION | n/a | At risk of export restrictions on shipments to CXMT following IEDM GAA transistor violation disclosure. |
| 2024-07-01 | [[irrationalanalysis]] | MENTION | n/a | Listed among WFE beneficiaries of the AI capex buildout |
| 2024-10-20 | [[irrationalanalysis]] | LONG | n/a | Long-term favorite semicap but wait before adding |
| 2025-05-11 | [[irrationalanalysis]] | LONG | n/a | Re-purposed process-control tools dominate CoWoS-L advanced packaging inspection; preferred balanced-risk long leg against ONTO short |
...
## Outcome tracking
No px@call values are recorded in the log, so price-based verification is not possible. The thesis trajectory is consistently constructive: each successive call either maintains or upgrades conviction, and the structural argument — process-control intensity rising with node complexity — has been reinforced rather than falsified by events, as TSMC's CoWoS-L qualification win for KLA emerged as a concrete share-gain proof point. The two near-term risk flags flagged by irrationalanalysis are Intel capex cuts (August 2025) and maximum personal leverage preventing position addition despite conviction (January 2026); neither represents a thesis reversal. The live bull case would be falsified by evidence that process-control intensity plateaus at leading-edge nodes, that ONTO or a new entrant displaces KLA in advanced packaging metrology, or that a sustained Intel capex cut cycle reduces WFE demand enough to compress KLA's backlog materially.
