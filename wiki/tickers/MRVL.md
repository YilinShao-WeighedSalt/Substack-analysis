...
| 2026-08-05 | [[semidoped]] | NEUTRAL | 211.02 | Rallied on substitution, but its DSPs sit inside the banned Chinese modules - double-edged. |

| 2026-08-19 | [[semidoped]] | LONG | 251.01 | Google granted option to buy $12.2B (~7%) of Marvell tied to TPU supply; vests one tranche/$500M custom-silicon rev (~$120B to FY33, ~$18B/yr); CXL read-through positive |
| 2026-08-28 | [[semidoped]] | NEUTRAL | 216.62 | Beat + raise but shares fell — cited $120B Google figure is multi-year cumulative, not a near-term booking; timing murky |
| 2026-09-21 | [[semidoped]] | LONG | 262.36 | Industry-first 2nm optical (co-packaged) tech to demo at ECOC 2026 |
...
**Update 2026-08-06:** SD NEUTRAL $211.02 (Aug-5) — a deliberately two-sided read: Marvell rallied on the substitution trade, but the expensive silicon inside a banned Innolight 800G module is often a **Marvell (or Broadcom) DSP**, so banning the module also hits MRVL/AVGO volume. Prior SA Jul-2 long ($245.29) and SD Jun-19 long ($309) both resolved losses in the July rout; the stock has since bounced to $211. Net: the ban is not cleanly bullish for Marvell.


**Update 2026-08-21:** Semi Doped LONG $251.01 on the **Google–Marvell equity option** — Google may buy up to $12.2B (~7%, ~59M shares) of Marvell, vesting one tranche per $500M of custom-silicon revenue through FY2033 (full vest = ~$120B of Google purchases, ~$18B/yr from a single customer). Structurally validates the TPU/custom-ASIC franchise and, per the host, is positive for Marvell CXL too (Google understood to be a buyer). The stock has climbed from the Aug-5 SD neutral ($211.02, now **+19.0%**) back toward the ECTC-long entry ($245.29) — the first clean bull catalyst since the late-July SerDes-doubt derating.
